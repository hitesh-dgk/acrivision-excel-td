...
class TowerInputTdGenerator {
    private sections: any;
    constructor() {
        console.log("inside TowerInputTdGenerator");
        this.sections = {
            "legs": [],
            "bracings": [],
            "horizontals": [],
    ...
    public processTowerInput(jsonArray: any) {
        ...
        // console.log(panelCollector);
        // return "Done";
        return this.geneateTowerInputTdFile(titleCollector, panelCollector);
    ...
    private geneateTowerInputTdFile = (titleCollector: any, panelCollector: any): string => {
...
export default TowerInputTdGenerator;